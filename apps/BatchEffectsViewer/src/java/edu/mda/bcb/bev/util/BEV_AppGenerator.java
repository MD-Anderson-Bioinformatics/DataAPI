...
// This clas is run during build to generate a stand-alone HTML file

/* Add this code to the build.xml file
<project name="BatchEffectsViewer" default="default" basedir=".">
    <description>Builds, tests, and runs the project BatchEffectsViewer.</description>
    <import file="nbproject/build-impl.xml"/>
	<target name="-pre-dist">
		<java classname="edu.mda.bcb.bev.util.BEV_AppGenerator">
			<arg line="${build.web.dir} ${standAloneName}" />
			<classpath>
...
/* Add this code to the project.properties file
standAloneName=bevApp.html
*/
...
public class BEV_AppGenerator
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			System.out.println("BEV_AppGenerator write to "  +args[0] + "/" + args[1]);
			BufferedReader br = new BufferedReader(new FileReader(args[0] + "/" + "index.html"));
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(args[0] + "/" + args[1]), "UTF8"));
			...
			System.out.println("BEV_AppGenerator output at "  +args[0] + "/" + args[1]);
		}
		catch (Exception e)
		{
