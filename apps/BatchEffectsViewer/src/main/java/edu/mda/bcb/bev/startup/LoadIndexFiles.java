...
public class LoadIndexFiles implements ServletContextListener
{
	...
	// USE THESE VALUES FOR testing and checking in MQA and MOB/MtOB
	...
	//static public String M_BEV_DIA_INDEX_FILE = "/BEA/DAPI_MQA/INDEXES/DNE_data_index_gdc.tsv_DNE";
	//static public String M_BEV_DSC_INDEX_FILE = "/BEA/DAPI_MQA/INDEXES/DNE_dsc_index_gdc.tsv_DNE";
	//static public String M_BEV_KWD_INDEX_FILE = "/BEA/DAPI_MQA/INDEXES/DNE_kwd_index_gdc.tsv_DNE";
