...
public class Query
{
	...
	{
		return theIndexes.query(mFiles, mSources, mVariants, mProjects, mSubprojects, mCategories, mPlatforms, mData, mAlgorithms, 
				mDetails, mVersions, mOverallDSCmin, mOverallDSCmax, mOverallDSCpvalue);
	}
}
