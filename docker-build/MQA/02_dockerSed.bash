...
MQA_INDEXPATH=${LOCAL_PATH_ENV}/indexes
DSCPATH=${LOCAL_PATH_ENV}/dsc_indexes
# path to DATA
DATA_PATH=${9}
OUTSIDE_DATA_PATH=${DATA_PATH}
MQA_OUTSIDE_DATA_PATH=${DATA_PATH}
...
sed -e "s|<RELEASE_VERSION>|MQA_${RELEASE}|g" \
...
sed -e "s|<OUTSIDE_PORT>|${OUTSIDE_PORT}|g" \
    ...
    -e "s|<MQA_INDEXPATH>|${MQA_INDEXPATH}|g" \
    -e "s|<DSCPATH>|${DSCPATH}|g" \
    -e "s|<MQA_OUTSIDE_DATA_PATH>|${MQA_OUTSIDE_DATA_PATH}|g" \
