...
pandoc --metadata=title:"Omic Browser Data" -o ${STD_DIR}/apps/BatchEffectsViewer/src/main/webapp/OmicBrowserData.html --self-contained ${DOC_DIR}/BEV/OB_01D_MBatchData.docx
...
curl -o ${STD_DIR}/apps/BatchEffectsViewer/src/main/webapp/view/lib/ngchmEmbed-min.js https://raw.githubusercontent.com/MD-Anderson-Bioinformatics/NG-CHM-Artifacts/2.24.1-build-23/viewer.standalone/ngchmEmbed-min.js
curl -o ${STD_DIR}/apps/BatchEffectsViewer/src/main/webapp/view/lib/ngchmWidget-min.js https://raw.githubusercontent.com/MD-Anderson-Bioinformatics/NG-CHM-Artifacts/2.24.1-build-23/viewer.standalone/ngchmWidget-min.js
...
rm ${STD_DIR}/apps/BatchEffectsViewer/src/main/webapp/view/lib/jquery-ui-1.13.2/index.html
rm ${STD_DIR}/apps/BatchEffectsViewer/src/main/webapp/query/jquery-ui-1.13.2/index.html
